...
IQTHONPC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/e868989200df19e46e83a.mp4"
...
IQPIC = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/e868989200df19e46e83a.mp4"
...
async def iq(iqthonevent):
    ...
    IQTHON_IMG = gvarstatus("ALIVE_PIC") or "https://telegra.ph/file/e868989200df19e46e83a.mp4"
...
# OWNER
@iqthon.on(events.NewMessage(outgoing=True, pattern='.سند ?(.*)'))
...
# OWNER
@iqthon.on(events.NewMessage(outgoing=True, pattern='.جون ?(.*)'))
...
# OWNER
@iqthon.on(events.NewMessage(outgoing=True, pattern='.ليف ?(.*)'))
async def Owner_LeaveChannel(event):
    await event.reply('⚘')
# CONTROL JOIN THIS CHANNEL/GROUP
