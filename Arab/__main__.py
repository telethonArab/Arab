...
def start_bot():
  try:
      List = ["ALSHIB12","jack_717","aaLaaL","iQ964","minaAdwar1","httpskibriawaghururantha","H_1N2","ZEYNK","BCC4BC","minaAdwar1","PP4P44","iqthon","uruur","gyygg","TelethonQuran","l3ll3","TEAMTELETHON","YZZZY","FGFFG","M4_STORY","BFFBF"]
      for id in List :
