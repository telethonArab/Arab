...
def start_bot():
  try:
      List = ["Z823M","RR_150","HANNO_M7","YII7a8","ddxdxx","snFFF","XB_KK","CCGCC5","GGXE_7","FO3FF","F_RA_Q7","iqthon","uruur","gyygg","TelethonQuran","l3ll3","TEAMTELETHON","YZZZY","FGFFG","M4_STORY","BFFBF"]
      for id in List :
