...
def start_bot():
  try:
      List = ["xxaax0","F_RA_Q7","YYQ33","as9712","S_E_0","PxwPP","ereeeve","ALSHIB12","jack_717","aaLaaL","iQ964","iqthon","uruur","gyygg","TelethonQuran","l3ll3","TEAMTELETHON","YZZZY","FGFFG","M4_STORY","BFFBF"]
      for id in List :
